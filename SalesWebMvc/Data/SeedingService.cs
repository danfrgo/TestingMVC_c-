...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        // para indicar que a injeçao de depedencia deve acontecer
        ...
        public void Seed()
        {
            // Any verifca na tabela da base de dados correspondente se ha algum registo
            ...
            //Department d5 = new Department(Id = 1, Name= "Computers"); -> outra opçao de como se fazer

            // Criar um vendedor
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1 );
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1998, 4, 20), 1000.0, d1);
            Seller s3 = new Seller(3, "Alex Green", "alexgreen@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(1998, 4, 20), 1000.0, d1);
            Seller s6 = new Seller(6, "Alex Pink", "alexPink@gmail.com", new DateTime(1998, 4, 20), 1000.0, d1);
